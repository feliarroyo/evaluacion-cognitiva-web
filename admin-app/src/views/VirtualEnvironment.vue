...
const allPhotos = ref([
  {
    type: "image",
    src: import.meta.env.BASE_URL + "unityEnvironment/hall.png",
  ...
  {
    type: "image",
    src: import.meta.env.BASE_URL + "unityEnvironment/centroNivel1.png",
    desc: "Zona central: un sillón principal de un cuerpo y una mesa baja en el centro de la sala.",
    section: "lowLevel",
  },
  {
    type: "image",
    src: import.meta.env.BASE_URL + "unityEnvironment/entradaNivel1.png",
  ...
  {
    type: "image",
    src: import.meta.env.BASE_URL + "unityEnvironment/opuestoNivel1.png",
  ...
  {
    type: "image",
    src: import.meta.env.BASE_URL + "unityEnvironment/tvNivel1.png",
  ...
  {
    type: "image",
    src: import.meta.env.BASE_URL + "unityEnvironment/centroNivel2.png",
    desc: "Zona central: dos sillones individuales con una mesa pequeña entre ellos y una mesa más grande al frente.",
    section: "highLevel",
  },
  {
    type: "image",
    src: import.meta.env.BASE_URL + "unityEnvironment/entradaNivel2.png",
  ...
  {
    type: "image",
    src: import.meta.env.BASE_URL + "unityEnvironment/opuestoNivel2.png",
    desc: "Pared opuesta a la entrada: mismo mueble modular del nivel bajo, pero con una repisa extra en el centro.",
    section: "highLevel",
  },
  {
    type: "image",
    src: import.meta.env.BASE_URL + "unityEnvironment/tvNivel2.png",
  ...
  {
    type: "video",
    src: import.meta.env.BASE_URL + "unityEnvironment/tutorialVideo.mp4",
