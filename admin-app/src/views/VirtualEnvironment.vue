<template>
  <div class="flex flex-col min-h-screen p-4">
    ...
    <div class="w-full flex items-center mb-4">
      <button
        @click="goBack"
        class="text-lg font-bold px-3 py-1 rounded bg-gray-200 hover:bg-gray-300"
      >
        ← Volver
      </button>
    </div>
    ...
    <!-- Título -->
    <h1 class="text-3xl font-bold mb-10 text-center w-full">
      ...
      <div class="flex flex-col items-center w-full max-w-5xl">
        ...
        <div class="flex items-center w-full">
          ...
          <img
            ...
            class="flex-grow max-h-[70vh] object-contain rounded shadow"
          />
...
const photos = ref([
  {
    src: "public/unityEnvironment/tvNivel2.png",
  ...
  {
    src: "public/unityEnvironment/centroNivel1.png",
    desc: "Nivel 1: zona central, un sillón y una mesa.",
  },
  {
    src: "public/unityEnvironment/entradaNivel1.png",
  ...
  {
    src: "public/unityEnvironment/opuestoNivel1.png",
  ...
  {
    src: "public/unityEnvironment/tvNivel1.png",
  ...
  {
    src: "public/unityEnvironment/opuestoNivel2.png",
